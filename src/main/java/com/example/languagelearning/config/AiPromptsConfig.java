...
public class AiPromptsConfig {
    ...
    public void setMainPrompt(String mainPrompt) {
        log.info("Setting main prompt, length: {}", mainPrompt != null ? mainPrompt.length() : "null");
        this.mainPrompt = mainPrompt;
    }
    
    public void setGrammarExplanations(Map<String, String> grammarExplanations) {
        log.info("Setting grammar explanations, size: {}", grammarExplanations != null ? grammarExplanations.size() : "null");
